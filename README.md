...
- Allows automatic **cover letter generation** for selected jobs
- Enables analysis of the job market using Python

## Current Pipeline
1. Collect job postings automatically
2. Extract structured job information
3. Score jobs based on relevance and personal fit
4. Store results in a structured table
5. Analyze the data in Jupyter Notebook
...
- Store processed data in **Google Cloud**
